...
class PetServiceImpl : PetService {
    ...
    constructor(gunguRepo: gunguRepository, countryRepository: CountryRepository,centerRepo: CenterRepository) {
    ...
    override fun addToCenter(siName:String,gunguName:String) {
        ...
        println(findGunGu.gunguCode.toString())
        ...
        for(i in 0 until item.length()){
            ...
            println(jObject.get("careRegNo").toString())
            center.centerCode = jObject.get("careRegNo").toString()
            center.centerName = jObject.get("careNm").toString()
            center.siName = findGunGu.siName.toString()
            center.gunguName = findGunGu.gunguName.toString()
